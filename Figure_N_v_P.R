...
new <- CC %>% drop_na
new <- new %>%
  mutate(quadrant = case_when(retention_percent_TP >= 0 & retention_percent_TN >= 0 
                            & retention_percent_TP >= retention_percent_TN        ~ "aQuad 1under",
                            retention_percent_TP >= 0 & retention_percent_TN >= 0 
                            & retention_percent_TP < retention_percent_TN        ~ "fQuad 1over",                              
                            retention_percent_TP <= 0 & retention_percent_TN >= 0~ "eQuad 2",
                            retention_percent_TP <= 0 & retention_percent_TN <= 0 
                            & retention_percent_TP >= retention_percent_TN        ~ "cQuad 3under",
                            retention_percent_TP <= 0 & retention_percent_TN <= 0 
                            & retention_percent_TP < retention_percent_TN        ~ "dQuad 3over",
                            retention_percent_TP >= 0 & retention_percent_TN <= 0 ~ "bQuad 4",
                            retention_percent_TP == retention_percent_TN ~ 'SAME'))
...
tiff(filename = "figures/Solute_retention5.tif", height=4, width=6, units= "in", res=800, compression= "lzw")
...
TN.TP2 <- ggplot(new, aes(x = BMPType, fill = quadrant)) +
...
PO4.TP2 <- ggplot(new2, aes(x = BMPType, fill = quadrant)) +
  geom_bar(width = 0.75,color = 'black') +
  theme_classic(base_size = 10) +
  scale_fill_manual(breaks = c("fQuad 1over", "aQuad 1under", "eQuad 2",
                               "dQuad 3over", "cQuad 3under", "bQuad 4"), 
...
NO3.NH42 <- ggplot(new3, aes(x = BMPType, fill = quadrant)) +
  geom_bar(width = 0.75,color = 'black') +
  theme_classic(base_size = 10) +
  scale_fill_manual(breaks = c("fQuad 1over", "aQuad 1under", "eQuad 2",
                               "dQuad 3over", "cQuad 3under", "bQuad 4"), 
...
TN.NO32 <- ggplot(new5, aes(x = BMPType, fill = quadrant)) +
  geom_bar(width = 0.75, color = 'black') +
  theme_classic(base_size = 10) +
  scale_fill_manual(breaks = c("fQuad 1over", "aQuad 1under", "eQuad 2",
                               "dQuad 3over", "cQuad 3under", "bQuad 4"), 
...
TN.NH42 <- ggplot(new6, aes(x = BMPType, fill = quadrant)) +
  geom_bar(width = 0.75, color = 'black') +
  theme_classic(base_size = 10) +
  scale_fill_manual(breaks = c("fQuad 1over", "aQuad 1under", "eQuad 2",
                               "dQuad 3over", "cQuad 3under", "bQuad 4"), 
...
tiff(filename = "figures/Solute_retention_supp_unscaled.tif", height=4, width=6, units= "in", res=800, compression= "lzw")

plot_grid(inset, TN.TP2, PO4.TP2, NO3.NH42, TN.NO32, TN.NH42,
          labels = c("A) ","B) TN vs TP", "C) TP vs PO4 ", 
                     "D) NH4 vs NO3" , "E) TN vs NO3", "F) TN vs NH4 "),
          ncol = 3, rel_heights = c(1,1), label_size = 10, label_x = 0, hjust = 0)
